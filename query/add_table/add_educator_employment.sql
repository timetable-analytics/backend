...
update [local_db].[dbo].[EducatorEmployment] set is_active = (select [timetable-live].[dbo].[EducatorEmployment].[IsActive] from [timetable-live].[dbo].[EducatorEmployment] where [local_db].[dbo].[EducatorEmployment].id = [timetable-live].[dbo].[EducatorEmployment].Oid);